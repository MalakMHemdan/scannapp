        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Admain_BranchID = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdmainID = table.Column<int>(type: "int", nullable: false),
                    SuperAdmainID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Branches", x => x.BranchID);
                    table.ForeignKey(
                        name: "FK_Branches_AspNetUsers_SuperAdmainID",
                        column: x => x.SuperAdmainID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BonusApplied = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserOffers_AspNetUsers_SuperAdmainID",
                        column: x => x.SuperAdmainID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Points_AspNetUsers_AdminID",
                        column: x => x.AdminID,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Points_Branches_BranchId",
                        column: x => x.BranchId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Admain_BranchID",
                table: "AspNetUsers",
                column: "Admain_BranchID",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_SuperAdmainID",
                table: "Branches",
                column: "SuperAdmainID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserOffers_SuperAdmainID",
                table: "UserOffers",
                column: "SuperAdmainID");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Branches_Admain_BranchID",
                table: "AspNetUsers",
                column: "Admain_BranchID",
                principalTable: "Branches",
                principalColumn: "BranchID");
